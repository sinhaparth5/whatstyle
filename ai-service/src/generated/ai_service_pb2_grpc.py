...
class AIServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GenerateResponse = channel.unary_unary(
                '/aiservice.AIService/GenerateResponse',
        ...
        self.TrainUserModel = channel.unary_unary(
                '/aiservice.AIService/TrainUserModel',
                request_serializer=ai__service__pb2.TrainingRequest.SerializeToString,
                response_deserializer=ai__service__pb2.TrainingResponse.FromString,
                _registered_method=True)
...
def add_AIServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'TrainUserModel': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=ai__service__pb2.TrainingResponse.SerializeToString,
            ),
    }
...
class AIService(object):
    ...
    def TrainUserModel(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            ai__service__pb2.TrainingResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
